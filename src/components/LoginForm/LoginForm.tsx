          ...
          <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
            ...
            <form className='space-y-4 md:space-y-6' action='#'>
              ...
              <div className='flex items-center justify-between'>
                <div className='flex items-start'>
                  <div className='flex items-center h-5'>
                    <input
                      ...
                      type='checkbox'
                      className='w-4 h-4 border rounded focus:ring-3 bg-gray-700 border-gray-600 focus:ring-sky-600 ring-offset-gray-800'
                      required
                    />
                  </div>
                ...
                <a href='#' className='text-sm font-medium hover:underline text-sky-500'>
                  Forgot password?
                </a>
              </div>
              <button
              ...
              <p className='text-sm font-light text-gray-400'>
                ...
                <a href='#' className='font-medium hover:underline text-sky-500'>
                  Sign up
                </a>
              </p>
            </form>
